...
def drawBoard(board):
    ...
    tensDigitsLine = '    ' # initial space for numbers down the left side of the board
    for i in range (1, 6):
...
def getRandomChests(numChests):
    # Creat a list of chest data structures (two-item lists of x, y int coordinates).
    chests = []
...
def makeMove(board, chests, x, y):
    # Change the board data structure with a sonar device character. Remove the treasure chests from the chests list as they are found.
    # Return False if this is and invalid move.
...
3 because the clostest chest is 3 spaces away.
...
The treasure chests don't move around. Sonar devices can detect treausure chests
